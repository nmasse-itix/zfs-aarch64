...
%if 0%{?rhel}%{?fedora}%{?mageia}%{?suse_version}%{?openEuler}
Requires:       kernel-devel >= 4.18, kernel-devel <= 6.19.999
Requires(post): kernel-devel >= 4.18, kernel-devel <= 6.19.999
Conflicts:      kernel-devel < 4.18, kernel-devel > 6.19.999
Requires:       kernel-uname-r >= 4.18, kernel-uname-r <= 6.19.999
Requires(post): kernel-uname-r >= 4.18, kernel-uname-r <= 6.19.999
Conflicts:      kernel-uname-r < 4.18, kernel-uname-r > 6.19.999
